...
public class MainActivity extends AppCompatActivity {
    ...
    static RecyclerView questionLists;   // 리사이클러
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionLists.setLayoutManager(layoutManager);
        ...
        questionLists.setAdapter(adapter);
        ...
        adapter.setOnItemClickListener(new OnQuestionItemClickListener() {
            ...
            public void onItemClick(QuestionAdapter.ViewHolder holder, View view, int position) {
                ...
                String titleName = item.getQtitle();
                ...
                switch (titleName) {
                    case "기숙사 들어가는 법":
                        ...
                        questionLists.setVisibility(View.INVISIBLE);
                        break;
                    case "학식 먹는 법":
                        moreInfo.setImage(R.drawable.applogo);
    ...
    private void initLoadDB() {
        ...
        questionList = mDBHelper.getTableData();
        mDBHelper.close();
    }
